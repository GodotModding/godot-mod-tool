...
func _init(modLoader = ModLoader) -> void:
	ModLoaderLog.info("Init", MODNAME_LOG_NAME)
...
func _ready() -> void:
	ModLoaderLog.info("Ready", MODNAME_LOG_NAME)
	...
	ModLoaderLog.info("Translation Demo: " + tr("MODNAME_READY_TEXT"), MODNAME_LOG_NAME)
